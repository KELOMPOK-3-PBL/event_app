          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.search, color: UIColor.primary),
                suffixIcon: _searchController.text.isNotEmpty
                    ? IconButton(
                        icon: const Icon(Icons.clear, color: UIColor.primary),
                        onPressed: () {
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Theme(
          ...
          child: ExpansionTile(
            leading: Icon(icon, color: UIColor.primary),
            title: Text(
              title,
...
//           Row(
//             children: [
//               Icon(Icons.support_agent, color: UIColor.primary),
